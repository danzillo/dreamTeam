...
<section class="hero container">
    ...
    <p class="js1 _anim-items animnh">Каждый год самые яркие веб-дизайнеры и фронтенд-разработчики собираются в Риддере,
        чтобы обсудить новейшие технологии. Присоединяйся к нам этим летом!</p>
...
<section class="row">
    <div class="grid">
        ...
        <section class="teaser col-1-3 js _anim-items animnh">
            ...
            <p class="h8">К нам приедут более двадцати фантастических спикеров со всего мира, чтобы поделиться своими
                историями.</p>
        </section>
